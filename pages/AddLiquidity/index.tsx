    ...
    return noLiquidity ? (
      <AutoColumn gap="5px">
        <LightCard mt="20px" borderRadius="20px">
          <RowFlat>
            <Text fontSize="1.5rem" fontWeight={500} marginRight={10}>
              {currencies[Field.CURRENCY_A]?.symbol +
                "/" +
                currencies[Field.CURRENCY_B]?.symbol}
            </Text>
      ...
      <AppBody>
        ...
        <div>
          ...
          <AutoColumn gap="20px">
            ...
            {!account ? (
              <ButtonLight className="btn_mode" onClick={toggleWalletModal}>
                Connect Wallet
              </ButtonLight>
            ) : (
              <AutoColumn gap={"md"}>
                ...
                <ButtonError
                  ...
                  id="swap-button"
                >
                  <Text fontSize={20} fontWeight={500} className="text">
                    {error ?? "Supply"}
                  </Text>
                </ButtonError>
              </AutoColumn>
